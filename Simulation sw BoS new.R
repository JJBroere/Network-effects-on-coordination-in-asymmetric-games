...
setwd("C:/Users/3703800/Google Drive/Ph.D/Programming/R-scriptsright")
...
for(m in 1:200){
  ...
  repeat{
    g <- watts.strogatz.game(1, 20, 2, 0.05)
    COM <-components(g)$no
    if(COM == 1) break;  
  }
...
data005s7 <- data
save(data005s7, file="datasw005ns7.Rda")
...
data01s7 <- data
save(data01s7, file="datasw01ns7.Rda")
...
for(m in 1:200){
  ...
  #plot.igraph(g)
  repeat{
    g <- watts.strogatz.game(1, 20, 2, 0.15)
    COM <-components(g)$no
    if(COM == 1) break;  
  }
  #plot.igraph(g)
...
data015s7 <- data
save(data015s7, file="datasw015ns7.Rda")
...
for(m in 1:200){
  ...
  #plot.igraph(g)
  repeat{
    g <- watts.strogatz.game(1, 20, 2, 0.2)
    COM <-components(g)$no
    if(COM == 1) break;  
  }
  #plot.igraph(g)
...
data02s7 <- data
save(data02s7, file="datasw02ns7.Rda")
...
for(m in 1:200){
  ...
  #plot.igraph(g)
  repeat{
    g <- watts.strogatz.game(1, 20, 2, 0.25)
    COM <-components(g)$no
    if(COM == 1) break;  
  }
  #plot.igraph(g)
...
data025s7 <- data
save(data025s7, file="datasw025ns7.Rda")
...
data005s5 <- data
save(data005s5, file="datasw005ns5.Rda")
...
data01s5 <- data
save(data01s5, file="datasw01ns5.Rda")
...
data015s5 <- data
save(data015s5, file="datasw015ns5.Rda")
...
data02s5 <- data
save(data02s5, file="datasw02ns5.Rda")
...
data025s5 <- data
save(data025s5, file="datasw025ns5.Rda")
